...
SESSION_ID: process.env.SESSION_ID === undefined ? 'VAJIRA-MD=HUVTBQbJ#OMT3_oexZgQAEezeI2GD9IhNDyfjJF9DFCtSNr48SWA' : process.env.SESSION_ID,
OWNER_NUMBER: process.env.OWNER_NUMBER === undefined ? '+94767486860' : process.env.OWNER_NUMBER,   
